...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/goats-9/ee3900-assignmnets/main/pingala/codes/1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 1.py
...
Download the Python code using
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/goats-9/ee3900-assignmnets/main/pingala/codes/2_1.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2_1.py
...
Download the Python code using
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/goats-9/ee3900-assignmnets/main/pingala/codes/2_2.py
\end{lstlisting}
and run it using
\begin{lstlisting}
$ python3 2_2.py
