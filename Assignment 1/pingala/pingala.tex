...
\begin{document}
	...
	%
	\author{ Shreyas wankhede %<-this  stops a space
	}
 % <-this % stops a space
...
\begin{lstlisting}
	https://github.com/shreyaswankhede12/EE3900/blob/master/Assignment%201/pingala/1.1.py
\end{lstlisting}
\begin{figure}[h]
	\centering
...
Run the below python code 
\begin{lstlisting}
	https://github.com/shreyaswankhede12/EE3900/blob/master/Assignment%201/pingala/1.4.py
\end{lstlisting}
\begin{figure}[h]
	\centering
...
Run the below python code 
\begin{lstlisting}
	https://github.com/shreyaswankhede12/EE3900/blob/master/Assignment%201/pingala/2.1.py
\end{lstlisting}
...
\item Find $X^{+}(z)$.\\
\solution:
Applying positive Z-transform (linear operator) on both sides of equation \ref{eq:xn}
\begin{align}
	&\sum_{k=0}^{\infty}x(k+2)z^{-k}=\sum_{k=0}^{\infty}x(k+1)z^{-k}+\sum_{k=0}^{\infty}x(k)z^{-k}\\
	&z^{2}(X^{+}(z)-x(0)-z^{-1}x(1))=z(X^{+}(z)-x(0))+X^{+}(z)\\
...
\solution:
\begin{equation}
	\frac{1}{1-z^{-1}-z^{-2}}=\frac{1}{(1-\alpha z^{-1})(1-\beta z^{-1})}\\
\end{equation}
...
\end{equation}
\begin{equation}
\implies X^{+}(z)=\frac{1}{\alpha-\beta}\left(\frac{\alpha}{1-\alpha z^{-1}}-\frac{\beta}{1-\beta z^{-1}}\right)
\end{equation}
As
\begin{align}
	\label{eq:anun}
...
Run the below python code 
\begin{lstlisting}
	https://github.com/shreyaswankhede12/EE3900/blob/master/Assignment%201/pingala/2.2.py
\end{lstlisting}
\begin{figure}[h]
	\centering
